...
###this program can reproduce simulations results in Tables 1-4 in main text and Tables S1-S2 in supplementary materials
###author: Zhiqiang CAO
...
#####################################main program#########################
#sample size: 1000, 5000 or 10000
#choosing n=5000 or 10000 reproduce simulations in Tables 1-4
#choosing n=1000 reproduce simulations in Table S1-S2
n = 5000   #sample size, which can be 1000, 5000 or 10000
#simulation times
N = 1000 

#two choices of regression coefficients
choice = 1 #choice=1 for tables 1-2; and choice=2 for tables 3-4
if(choice == 1){ 
...
qna = qnorm(0.975)
#gamma choice
lambda_set = c(5/7,1,1.4);    #three choices for shape parameter gamma
final_res = NULL
for(j in 1:3){
  lam = lambda_set[j]
  c1 = c_set[j]
...
#final results in Tables 1-4 and Tables S1-S2
